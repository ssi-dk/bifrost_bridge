...
def process_qc_data_from_cli() -> None:
    parser = build_parser(
        ...
        [
            {"names": ["--mlst_path"], "kwargs": {"default": None}},
            {"names": ["--fastp_path"], "kwargs": {"default": None}},
            {"names": ["--quast_path"], "kwargs": {"default": None}},
            ...
            {"names": ["--ssiamb_path"], "kwargs": {"default": None}},
            {
                "names": ["--no_combine_output"],
