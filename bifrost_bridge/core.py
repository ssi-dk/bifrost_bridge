...
def add_column(self, column_name, data):
    ...
    if len(self.df) == 0:
        ...
        if len(data) != len(self.df):
            raise ValueError("Error: Length of data must match the number of rows in the DataFrame.")
