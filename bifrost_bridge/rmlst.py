...
def process_rmlst_data(
    ...
    if parsed:
        ...
        if os.stat(input_path).st_size > 0:
            ...
            taxon_prediction_df = taxon_prediction_df.apply(concatenate_vector, axis=0).to_frame().T # concatenate the list 
