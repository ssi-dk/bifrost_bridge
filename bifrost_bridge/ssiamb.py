# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/11_ssiamb.ipynb.

# %% auto #0
__all__ = ['process_ssiamb_data', 'process_ssiamb_data_from_cli']

# %% ../nbs/11_ssiamb.ipynb #9ca6843f
...
def process_ssiamb_data(
    ...
    """
    Command-line interface for processing SSIAMB data.

    This function sets up an argument parser to handle command-line arguments for processing SSIAMB data files.
...
@call_parse
def process_ssiamb_data_from_cli(
    input_path:str,
    output_path:str = './output.tsv',
    filter_columns:str = None,
    replace_header:str = None):
    process_ssiamb_data(input_path, output_path, filter_columns, replace_header)
