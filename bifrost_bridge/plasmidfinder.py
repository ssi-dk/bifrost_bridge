...
# %% ../nbs/05_plasmidfinder.ipynb #aeca7cc5
...
# %% ../nbs/05_plasmidfinder.ipynb #ce5035d9
...
def process_plasmidfinder_data_from_cli(
    ...
    convert_coverage:bool = False,
    filter_contig:bool = False):
    process_plasmidfinder_data(input_path, output_path, replace_header, filter_columns, convert_coverage, filter_contig)
